...
export function DataManagement({ employees, bocs, vrfs, onRestore }: DataManagementProps) {
  ...
  const handleSave = () => {
    const data = { employees, bocs, vrfs };
  ...
  return (
    <div className="flex gap-2">
      <button
        onClick={handleSave}
        className="inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-dark-text-secondary hover:bg-gray-100 dark:hover:bg-dark-border transition-colors"
